...
<body>
    ...
    <div class="container">
        ...
        <form action="proses_tambahprestasi.php" method="post" enctype="multipart/form-data" onsubmit="return validateLinkedInURL();">
    ...
    function validateLinkedInURL() {
        var urlInput = document.getElementById("url_linkedin").value;
        if (!urlInput.startsWith("https://www.linkedin.com/")) {
