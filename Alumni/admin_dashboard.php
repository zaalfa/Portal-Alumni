...
document.addEventListener('DOMContentLoaded', function () {
    fetch("data_alumni.php")
        ...
        .then((data) => {
            ...
            // Display total counts next to the chart
            var totalCounts = data.Vokasi + data.Sarjana + data.Magister + data.Spesialis + data.Doctor;
            var totalCountsElement = document.getElementById("totalCounts");
            totalCountsElement.innerText = "Total: " + totalCounts;

            // Display counts for each category
            var categoryCountsElement = document.getElementById("categoryCounts");
            categoryCountsElement.innerHTML = `
                <p>Vokasi: ${data.Vokasi}</p>
                <p>Sarjana: ${data.Sarjana}</p>
                <p>Magister: ${data.Magister}</p>
      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li><a href="#home">Informasi Alumni</a></li>
...
<section id="home">
  <div class="container">
    ...
    <div id="categoryCounts">
        <div class="categoryCountContainer" id="VokasiContainer"><p>Vokasi: <span id="Vokasi"></span></p></div>
        <div class="categoryCountContainer" id="SarjanaContainer"><p>Sarjana: <span id="Sarjana"></span></p></div>
        <div class="categoryCountContainer" id="MagisterContainer"><p>Magister: <span id="Magister"></span></p></div>
        <div class="categoryCountContainer" id="SpesialisContainer"><p>Spesialis: <span id="Spesialis"></span></p></div>
        <div class="categoryCountContainer" id="DoctorContainer"><p>Doctor: <span id="Doctor"></span></p></div>
    </div>
</div>
</div>
</section>
...
<div class="container">
    ...
    <footer>
      <div class="container">
        ...
        <a href="https://dpka.ub.ac.id/" target="_blank"
