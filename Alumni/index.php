...
<section id="alumni-prestasi">
    <div class="container">
        <h2 class="section-heading">Alumni Berprestasi</h2>
        <div class="container">
    <?php
    // Koneksi ke database
    $host = "localhost";
    ...
    <section id="lowongan">
        <div class="container">
            <h2 class="section-heading">Lowongan Kerja</h2>
            <div class="row">
            <?php
            // Koneksi ke database
            $host = "localhost";
    ...
    <footer>
        <div class="container">
            ...
            <a href="https://dpka.ub.ac.id/" target="_blank">Layanan Karir Universitas Brawijaya</a>
        </div>
    </footer>
</body>
</html>
